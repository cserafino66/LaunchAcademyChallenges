...
if box_1.any? { |string| string == "denim shirt" } == false
  puts "There are no denim shirts."
else puts "Try this on for size!"
end

if box_1.any? { |string| string == "black nail polish" } == true
  puts "This box contains black nail polish."
else puts "Unforutnately, does not contain black nail polish."
end

if box_1.any? { |string| string == "silver nail polish"} == true
  puts "This box contains silver nail polish"
else puts "Unforutnately there is no silver nail polish in this box."
end
...
if box_3.all? {|string| string == "skinny jeans"} == true
  puts "This whole box is skinny jeans."
else puts "There are more than one kind of item in this box."
end
