...
people["Dr. Adela DuBuque"].merge!({"chidlren" => "Tomas"})
...
puts sets_of_people[1]["Dr. Sigrid Nader"]["children"][0..2]
...
sets_of_people[0].each do |name, company|
  if company["company"].downcase.include?('m')
    puts name
  end
end
